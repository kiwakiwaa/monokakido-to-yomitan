...
from parser.base.html_converter import HTMLToYomitanConverter
...
class Parser:
    def __init__(self, dict_name: str = None, dict_path: str = None, index_path: str = None, jmdict_path: str = None,
                 link_handling_strategy: LinkHandlingStrategy = None,
                 image_handling_strategy: ImageHandlingStrategy = None,
                 batch_size: int = 250):
        
        self.dictionary = Dictionary(dict_name) if dict_name else None
    ...
    def initialize_html_converter(self):
