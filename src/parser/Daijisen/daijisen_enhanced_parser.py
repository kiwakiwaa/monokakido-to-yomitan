...
from parser.Daijisen.daijisen_strategies import DaijisenLinkHandlingStrategy, DaijisenImagePathStrategy


class EnhancedDaijisenParser(EnhancedParser):
    ...
    def __init__(self, dict_name: str, dict_path: str, index_path: str, jmdict_path: str):
        ...
        super().__init__(
            ...
            image_path_strategy=DaijisenImagePathStrategy()
        )
